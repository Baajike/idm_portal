...
class _DashboardScreenState extends State<DashboardScreen> {
  String? lastScanTime; // stores last scan time
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                // Top row: Back arrow, Dashboard title, Profile icon
                Row(
                  children: [
                    IconButton(
                      icon: const Icon(
                ...
                // Greeting with dynamic first name
                Align(
              ...
              child: MobileScanner(
                onDetect: (barcodeCapture) async {
                  ...
                  if (mounted) {
                    ...
                    // Send timestamp back to Dashboard
